...
public class Docente extends Utente{
    ...
    public void inserisci_appello() {
        ...
        try {
            ...
            // 1. Recuperiamo l'ID dell'esame e il docente associato
            ...
            // 2. Controlliamo che il docente loggato sia effettivamente il docente di quell'esame
            if (!this.getID().equals(docenteID)) {
                System.out.println("Errore: Non sei il docente di questo esame. Operazione negata.");
                return;
            }

            // 3. Se il controllo è superato, inseriamo il nuovo appello
